...
<div class="wrapper">
  ...
  <div class="main_container">
    <div class="item">
	   ...
	   <form action="admin_search.jsp" id="srchForm" method="POST">
	    <div class="container">
...
%>
    <tr>
      ...
      <td><a target="_blank"  href="admin_view.jsp?id=<%=resultSet.getInt("id")%>" type="button" class="btn btn-outline-light">View Details</a></td>
