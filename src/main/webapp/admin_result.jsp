      ...
      <ul>
        ...
        <div class="title-dropdown-menu" aria-labelledby="navbarDropdown">   
          ...
          <i class="far fa-clipboard"></i>&nbsp;&nbsp;Quiz Test
            ...
            <a class="dropdown-item" href="admin_result.jsp"><i class="fas fa-poll"></i>&nbsp;&nbsp;Result</a>
               </div>
...
%>
    <tr>
      <th  scope="row"><%=resultSet.getInt("exam_id") %></th>
      <td><%=resultSet.getString("std_id") %></td>
      <td><%=resultSet.getString("course_name") %></td>
      <td><%=resultSet.getString("status") %></td>
      <td><a target="_blank"  href="admin_view.jsp?id=<%=resultSet.getInt("exam_id")%>" type="button" class="btn btn-outline-light">View Details</a>  </td>
      <td><a target="_blank" download="certification" href="images/<%=resultSet.getString("imageFileName")%>" type="button" class="btn btn-outline-warning">Download Certificate &nbsp;<i class="fas fa-download"></i></a></td>

<td><a href="delete.jsp?id=<%=resultSet.getString("id") %>"><button type="button" class="btn btn-outline-danger">Delete&nbsp;<i class="fas fa-trash-alt"></i></button></a></td>
