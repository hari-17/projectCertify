...
String sql ="select * from exams where std_id='"+emailid+"' order by date desc";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>
    <tr>
      <th   scope="row"><%=resultSet.getString("date") %></th>
      <td><%=resultSet.getString("course_name") %></td>
      <td><%=resultSet.getString("start_time") %>-<%=resultSet.getString("end_time") %></td>
