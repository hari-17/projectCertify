...
String sql ="select * from projectCertify where email='" + emailid + "'";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>
    <tr>
      <th hidden  scope="row"><%=resultSet.getInt("id") %></th>
      <td><%=resultSet.getString("emp_name") %></td>
      <td><%=resultSet.getString("csp") %></td>
      <td><%=resultSet.getString("certification_name") %></td>
       <td><a  href="view.jsp?id=<%=resultSet.getInt("id")%> "target="_blank" type="button" class="btn btn-outline-light">View Details</a></td>
       <td><a  href="edit.jsp?id=<%=resultSet.getInt("id")%>" target="_blank" type="button" class="btn btn-danger">Edit Details</a></td>
